...
(async function () {
  ...
  function md(node) {
    ...
    node.childNodes.forEach(function (n) {
      ...
      else if (t === 'a') out += '[' + inner + '](' + (n.href || n.getAttribute('href') || '') + ')';
      else if (t === 'img') {
  ...
  try {
    ...
    const payload = {
      ...
      jsonld: jsonld,
      html_raw: root.outerHTML,
      html_clean: cleaned.outerHTML,
      text_raw: root.innerText,
      text_clean: cleaned.innerText,
      user_agent: navigator.userAgent,
      source: 'bookmarklet_dom_capture',
