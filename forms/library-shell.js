...
(function () {
  ...
  const NAV_ITEMS = [
    ...
    { page: 'cook-kb',   label: 'Cooking tips KB', href: '/forms/cook_kb.html', group: 'admin' },
    { page: 'ingredient-synonyms', label: 'Ingredient synonyms', href: '/forms/ingredients.html', group: 'admin' },
