...
# Insert the recipe
cur.execute(
    "INSERT INTO recipes (user_id, data, created_at, updated_at) VALUES (?, ?, ?, ?)",
    (
...
print("Inserted full JSON recipe into database.")

conn = sqlite3.connect('C:/Users/john/PycharmProjects/forms/recipes')
cur = conn.cursor()
cur.execute("SELECT name FROM sqlite_master WHERE type='table';")
print(cur.fetchall())  # Should list your tables

cur.execute("SELECT id, data FROM recipes;")
print(cur.fetchall())  # Should list your recipe records
conn.close()
